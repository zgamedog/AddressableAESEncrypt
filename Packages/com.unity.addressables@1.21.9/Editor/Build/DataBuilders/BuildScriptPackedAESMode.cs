...
{
    [CreateAssetMenu(fileName = "BuildScriptPackedAES.asset", menuName = "Addressables/Content Builders/AES Build Script")]
    public class BuildScriptPackedAESMode : BuildScriptPackedMode
    {
